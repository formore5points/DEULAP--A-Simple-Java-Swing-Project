...
public class CustomerLogin {
	...
	public CustomerLogin() 
	{
		...
		btnLogIn.addActionListener(new ActionListener() 
		{
			...
			{
				if(txtUserName.getText().equals("berkay") &&
						passwordField.getText().equals("coskuner"))
				{
					frmLogIn.setVisible(false);
					Customer_Selection cs = new Customer_Selection();
					cs.setVisible(true);
				}
				else if(txtUserName.getText().equals("ilker") &&
						passwordField.getText().equals("soner"))
				{
						frmLogIn.setVisible(false);
						Customer_Selection cs = new Customer_Selection();
						cs.setVisible(true);
